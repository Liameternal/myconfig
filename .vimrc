...
" highlight Visual ctermbg=46

" customize highlight search color
...
" Exit terminal mode in nvim by sending an Escape key to the terminal by pressing <C-v><Esc>
if has('nvim')
    tnoremap <Esc> <C-\><C-n>
...
"     tnoremap <silent> <C-j> <C-\><C-n>:<C-U>:<C-U>TmuxNavigateDown<cr>
"     tnoremap <silent> <C-k> <C-\><C-n>:<C-U>:<C-U>TmuxNavigateUp<cr>
"     tnoremap <silent> <C-l> <C-\><C-n>:<C-U>:<C-U>TmuxNavigateRight<cr>
" endif
